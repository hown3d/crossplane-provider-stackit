...
PROJECT_NAME ?= crossplane-provider-stackit
PROJECT_REPO ?= github.com/stackitcloud/$(PROJECT_NAME)
...
XPKG_REG_ORGS ?= reg3.infra.ske.eu01.stackit.cloud/crossplane/xpkg
